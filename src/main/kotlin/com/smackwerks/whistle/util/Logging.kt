...
fun String.logger(): Logger = LogManager.getLogger(this)
fun String.d(msg: String) = logger().debug(msg)
fun String.i(msg: String) = logger().info(msg)
fun String.e(msg: String) = logger().error(msg)
fun String.e(msg: String, throwable: Throwable) = logger().error(msg, throwable)
fun String.w(msg: String) = logger().warn(msg)
fun String.w(msg: String, throwable: Throwable) = logger().warn(msg, throwable)
